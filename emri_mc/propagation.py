"""Module providing functions related to propagation"""

import emri_mc.global_parameters.physics as g   # import global parameters and initial conditions
import cupy as cp 
from scipy.integrate import fixed_quad  # ODE solvers etc.


## dL()
def dL(z, Ωm0 = 0.29, ΩΛ0 = 0.71, H0 = g.H0):
    """
    ...
    return (g.c/H0)*(1+z)*int_Ez                    # We assume low redshifts in this derivation. 
